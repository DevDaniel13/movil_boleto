...
public class Boleto {
    ...
    public Boleto(Boleto boleto){
        System.out.println("No. Boleto: "+boleto.getId());
        System.out.println("Nombre Cliente: "+boleto.getNombre());
        System.out.println("Destino: "+boleto.getDestino());
        System.out.println("Tipo Viaje: "+boleto.getTipoViaje());
    ...
    public int calcularTotal(int descuento){
        int total = (calcularImpuesto()+calcularSubtotal()) - descuento;
        return total;
    }
